sap.ui.define([
    ...
    function (Controller, MessageBox, UploadCollectionParameter) {
        ...
        function toStep2(oEvent) {
            //Step 1
            let dataEmployeeStep = this.byId("dataEmployeeStep");
        ...
        function dataEmployeeValidation(oEvent, callback) {
            let object = this._model.getData();
            let isValid = true;
        ...
        //Función link sección "Tipo de empleado"
        function editStepOne() {
            _editStep.bind(this)("typeEmployeeStep");
        }

        //Función link sección "Datos de empleado"
        function editStepTwo() {
            _editStep.bind(this)("dataEmployeeStep");
        }

        //Función link sección "Información adicional"
        ...
        //Se agrega el parametro de cabecera x-csrf-token con el valor del token del modelo para validar con SAP
        ...
        function onStartUpload(ioNum) {
            let that = this;
            let oUploadCollection = that.byId("UploadCollection");
            oUploadCollection.upload();
        }

        return Controller.extend("logaligroup.employee.controller.CreateEmployee", {
